...
function MomentumPortfolioView({ pilot }: { pilot: PilotExperiment | null }) {
  ...
  return <>
    <div className="page-heading"><div><div className="eyebrow">RESEARCH / MOMENTUM PILOT</div><h1>Lagged momentum portfolio</h1><p className="lede">A preliminary, monthly-rebalanced portfolio using only information available before each return month.</p></div><StatusBadge status="Preliminary" /></div>
