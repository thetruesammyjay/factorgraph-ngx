  ...
  return <>
    ...
    <div className="hero-grid">
      ...
      <div className="research-rail">
        ...
        <div className="rail-foot"><span className="check-circle review"><Database size={12} /></span><span>{quality ? "Price extraction passed · research inputs incomplete" : "Checking public-data validation"}</span></div>
      </div>
    </div>
